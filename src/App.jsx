      ...
      <div style={{padding:"10px 16px",borderBottom:"1px solid rgba(0,0,0,.12)",flexShrink:0}}>
        <div style={{display:"flex",alignItems:"center",justifyContent:"space-between"}}>
          ...
          <div style={{display:"flex",gap:4}}>
            ...
            :<button onClick={analyzePapers} disabled={inputPapers.length===0} style={{padding:"6px 14px",fontSize:12,fontWeight:600,borderRadius:7,border:"none",background:inputPapers.length>0?"linear-gradient(135deg,#ec4899,#8b5cf6)":"rgba(0,0,0,.04)",color:inputPapers.length>0?"#fff":"rgba(0,0,0,.1)"}}>{t.startAnalysis}</button>}
          </div>
        </div>
